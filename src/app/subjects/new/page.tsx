    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto page-transition">
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            <h1 className="text-3xl font-black text-white tracking-tighter uppercase">{t.add_subject}</h1>
            <p className="text-muted-foreground text-sm font-medium mt-1">Ajout d'une nouvelle matière ou d'un nouveau livre au catalogue.</p>
          </div>
        </div>
